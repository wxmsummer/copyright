...
func (d *CopyRightData) CalSig(pri *rsa.PrivateKey) (*CopyRightData, error) {
...
func Register(copyright *Copyright, pri string) (*CopyRightData, error) {
	data := CopyRightData{
		Copyright: copyright,
		Signature: "",
